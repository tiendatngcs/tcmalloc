...
ABSL_ATTRIBUTE_WEAK void MallocExtension_Internal_Background_ReleaseMemoryToSystem_Only();
ABSL_ATTRIBUTE_WEAK void MallocExtension_Internal_Background_ReleasePerCpuMemoryToOS_Only();
